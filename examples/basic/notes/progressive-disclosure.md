...
Progressive disclosure means agents load only the smallest useful amount of memory: core memory first, then a relevant memory map, then only the atomic notes, records, people notes, or sources needed for the task.
